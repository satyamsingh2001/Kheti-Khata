...
class _ChooseGroupState extends State<ChooseGroup> {
  bool _isClick = false;
  int _selectedGroupIndex = -1; // Initialize with no selection
                    ...
                    itemBuilder: (context, index) {
                      return index % 2 == 0
                          ? Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: ConstantContainer(
                                borderColor:_selectedGroupIndex == index? AppColors.primary60:AppColors.white60,
                                borderWidth: _selectedGroupIndex == index ? 1.5 : 1,
                                radiusBorder: 10,
                                child: ListTile(
                                  ...
                                  trailing: _selectedGroupIndex == index
                                      ? const Icon(
                          ...
                          : Padding(
                              ...
                              child: ConstantContainer(
                                borderColor:_selectedGroupIndex == index? AppColors.primary60:AppColors.white60,
                                borderWidth: _selectedGroupIndex == index ? 1.5 : 1,                                radiusBorder: 10,
                                child: ListTile(
                                  shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(10)),
                                  onTap: () {
